...
<head>
	<title>Conceit a Corporate Category Bootstrap Responsive Web Template | Signin :: w3layouts</title>
	<!--/tags -->
	...
	<div class="footer">
		<div class="footer_inner_info_w3ls_agileits">
			<div class="col-md-3 footer-left">
				<h2><a href="index"><i class="fa fa-clone" aria-hidden="true"></i> Conceit </a></h2>
