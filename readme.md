...
https://github.com/rappasoft/laravel-boilerplate for boilerplate code
 ...
 - ```php artisan make:migration create_users_table``` to make a migration from artisan, edit file in database/migration, ```heroku run php artisan migrate``` for database migration for the php files in database/migrations followed by ```heroku run php artisan db:seed``` as per https://dev.to/jsafe00/deploy-laravel-application-with-database-to-heroku-l50
